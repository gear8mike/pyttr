...
try:
    ...
    version = get_version('pyttr')
except ImportError:
    from pkg_resources import get_distribution
    version = get_distribution('pyttr').version

# -- Project information -----------------------------------------------------
short_version = '.'.join(version.split('.')[:2])
project = 'pyttr {}'.format(short_version)
copyright = '{0}, Mikhail Smirnov'.format(date.today().year)
...
html_title = "pyttr {}".format(version)
